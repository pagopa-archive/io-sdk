...
@test "cache cli" {
    run python3 src/util/cache.py set:pippo=pluto
    ckline "set:pippo=pluto"
    run python3 src/util/cache.py "scan:*"
    ckline '"pippo"'
    run python3 src/util/cache.py get:pippo
    ckline '"pippo": "pluto"'
    run python3 src/util/cache.py del:pippo
    ckline '"del:pippo": true'
    run python3 src/util/cache.py get:pippo
    ckline '"error": "cannot find pippo"'
    run python3 src/util/cache.py set:pippo:primo=pluto
    run python3 src/util/cache.py set:pippo:secondo=paperino
    run python3 src/util/cache.py scan:pippo:*
    ckline "pippo:primo"
    ckline "pippo:secondo"
    run python3 src/util/cache.py clean:pippo:*
